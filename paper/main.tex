...
CP-слоёв, растёт у TT- и продуктовых слоёв и переходит в полный отказ у независимых экспертов при более чем 64 экспертах. Во-вторых, разложения с общим базисом сжимают частотное
